...
<div class="alert alert-info clearfix" style="margin-top:-20px">
    ...
    <a style="align:center" class="btn btn-info pull-right" href="<c:url value='/${candidat.user_id}-afficherdocuments' />"> Voir ses documents</a><br>  
...
<div class="row">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <a class="btn btn-danger" href="<c:url value='/${candidat.user_id}-contacter' />">Cantacter</a>
  </div>
