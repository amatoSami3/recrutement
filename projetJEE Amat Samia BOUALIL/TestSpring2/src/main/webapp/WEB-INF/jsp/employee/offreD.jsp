...
<div class="row">
  ...
  <div class="row">
        ...
        <div class="col-sm-4" style="background-color:F4F7F7;"><strong>Responsable</strong></div>
        <div class="col-sm-8" style="background-color:F4F7F7;">${offreD.employee.user.name}  </div>
 ...
 <a href="/OffreDemande" class="btn btn-info" role="button">retour</a>
  </div>
  <br>
