...
<body>
    ...
    <a  class="alert-link" style="font-size:50px">Offres</a>
    <a style="align:center" class="btn btn-info pull-right" href="<c:url value='/newOffre' />">Ajouter un offre</a> <br>
    <a style="align:center" class="btn btn-info pull-right" href="<c:url value='/OffreDemande' />">Offres demand&eacute;s</a> 
...
<div class="container">	
  ...
  <br>
  <p>les offres qui sont encore valid </p>  	
  ...
  <table class="table table-striped">
    <thead>
      <tr>
         ...
         <td> <strong><font color="#009999"> Date de pblication          </font> </strong></td>
      ...
      <tr>
        ...
        <c:forEach items="${offres}" var="p">
            ...
            <td>${p.fonction}</td>
             ...
             <td><a  class="btn btn-primary" href="<c:url value='/${p.idOffre}-candidaturesParOffre' />">Candidatures</a></td>
             <td><a  class="btn btn-primary" href="<c:url value='/candidatsP' />">Candidats</a></td>
