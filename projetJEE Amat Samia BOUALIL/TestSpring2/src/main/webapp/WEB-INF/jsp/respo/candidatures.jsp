...
<div class="alert alert-info clearfix" style="margin-top:-20px">
    ...
    <a style="align:center" class="btn btn-info pull-right" href="<c:url value='/candidatsrespo' />"> afficher les candidats</a> 
  ...
  <table class="table table-striped">
    <thead>
      <tr>
         ...
         <td><strong> dateModification</strong></td>
     	 <td><strong> offre</strong></td>
         <td><strong> candidat</strong></td>
    ...
    <tbody id="myTable">
      <tr>
        <c:forEach items="${candidatures}" var="p">
            ...
            <td><a class="btn btn-primary" href="<c:url value='/${p.idCandidatures}-afficherRespo' />">Afficher le candidat</a></td>
       	    <td><a class="btn btn-info pull-right" href="<c:url value='/${p.idCandidatures}-ok' />">ok</a></td>
       	    <td><a class="btn btn-success" href="<c:url value='/delete-${p.idCandidatures}-Candidatures' />">regeter</a></td>
